...
let allTasks = []; // Aquí guardaremos temporalmente la lista de tareas del servidor
...
window.editTask = async (id) => {
    ...
    document.getElementById("task-id").value = task.id.toString();
